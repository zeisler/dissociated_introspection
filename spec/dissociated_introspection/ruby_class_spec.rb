...
describe DissociatedIntrospection::RubyClass do
  ...
  it "either source or ast on initialization" do
    expect{described_class.new}.to raise_error(ArgumentError, "DissociatedIntrospection::RubyClass require either source or ast to be given as named arguments.")
  end
